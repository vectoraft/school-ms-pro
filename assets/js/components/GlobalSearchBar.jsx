...
const GlobalSearchBar = ({ onResult }) => {
  ...
  return (
    <div className="relative w-full max-w-lg mx-auto mb-4">
      ...
      <h2 className="text-xl font-bold mb-4" data-tip={t("Send and receive internal messages with attachments and threads.")}>{t('Messaging')} <span className="text-gray-400 text-base">({t('Dynamic from API')})</span></h2>
    </div>
  );
};
